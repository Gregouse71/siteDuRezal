...
Attention : dans * src/base_url.js * se trouve l'url qui permet d'identifier l'api. Si vous déplacez le site, il faudra le modifier directement sur la machine qui hébrge le site. Ce fichier n'est pas suivi par git car il peut être différent sur l'ordinateur de chacun pour le développement.
