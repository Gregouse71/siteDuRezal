                ...
                switch (errorStatus) {
                    ...
                    case 500: {
                        popupService.changePopup({
                            status: "error",
                            message: "Erreur serveur, veuillez réessayer ou nous contacter par mail",
                        });
                        break;
                    }
                }
    ...
    return (
        <Suspense fallback={<Loading />}>
            <Routes>
                <Route
                    ...
                    element={
                        <authService.LoginFormComponent
                            redirectionPathIfSuccess="/resident/board"
                            title="Connexion résident"
                            displayAccountCreationLink={true}
                        />
                    }
                />
                ...
                <Route path="*" element={<Navigate to="/resident/board" replace />} />
            </Routes>
        </Suspense>
    );
}
