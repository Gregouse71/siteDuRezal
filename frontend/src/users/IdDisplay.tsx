                ...
                switch (errorStatus) {
                    ...
                    case 401: {
                        popupService.changePopup({
                            status: "error",
                            message:
                                "Le lien d'identification a expiré. Recommencez la procédure de nouveau mot de passe.",
                        });
                        break;
                    }
                    default:
            ...
            <FormControl id="new-password-form">
                ...
                <OutlinedInput
                    ...
                    endAdornment={
                        <InputAdornment position="end">
                            <IconButton
                                aria-label={show1 ? "hide the password" : "display the password"}
                ...
                <OutlinedInput
                    ...
                    endAdornment={
                        <InputAdornment position="end">
                            <IconButton
                                aria-label={show2 ? "hide the password" : "display the password"}
