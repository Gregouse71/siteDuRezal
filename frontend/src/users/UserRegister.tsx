                ...
                switch (errorStatus) {
                    case 400: {
                        popupService.changePopup({
                            status: "error",
                            message: "Cette adresse mail est déjà utilisée par un utilisateur",
                        });
                        break;
                    }
                    default:
                    ...
                    <Box sx={{ my: 4 }}>
                        <Box sx={{ p: 2, border: "1px solid grey.300", borderRadius: 1 }}>
                            ...
                            <Box sx={{ height: "70vh", my: 2 }}>
                                <iframe title="file" style={{ width: "100%", height: "100%" }} src={charte} />
                            </Box>
                            ...
                            <Box component="form" noValidate autoComplete="off">
                                ...
                                <FormControl margin="normal">
                                    <Grid columns={12} container>
                                        <Grid size={6}>
                                            <FormLabel>Promotion des Mines</FormLabel>
                                        </Grid>
                                        <Grid size={6}>
                                            <Select
                                                name="promotion"
                    ...
                    <Box sx={{ my: 4 }}>
                        <Box sx={{ p: 2, border: "1px solid grey.300", borderRadius: 1 }}>
                            ...
                            <Typography variant="body1">
                                Ton compte a bien été créé. Tu vas recevoir un mail d'ici quelques minutes dans lequel
                                se trouve un lien qui te permettra de récupérer tes identifiants. Tu as une semaine pour
                                cliquer dessus pour valider ton inscription.
                            </Typography>
                        </Box>
                    </Box>
                </Container>
