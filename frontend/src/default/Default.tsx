        ...
        <div className="home-wrapper">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 main-content">
                            ...
                            <div className="main-buttons">
                                ...
                                <Link to="/about-us" className="btn btn-info btn-lg">Plus d'information</Link>
                            </div>
                        </div>
            ...
            <div className="services-section">
                <div className="container">
                    ...
                    <div className="section-subtitle">Le but premier de l'association est de fournir un accès internet à ses adhérents résidents de la Maison des Mines et des Ponts, par WiFi et en filaire.</div>
                </div>
            </div>
