    ...
    return <div id="container-about-us" style={{ textAlign: "left" }}>
        ...
        <div>
            ...
            <ul>
                ...
                <li>Pour les chromebook : Renseignez les mêmes paramètres que pour Android. Pour le certificat, utiliser <em>Par défaut</em>. Pour <em>Correspondance du suffixe de domaine</em> reiseignez <em>rezal-mdm.com</em></li>
            </ul>
